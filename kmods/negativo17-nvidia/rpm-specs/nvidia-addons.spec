...
Source2:        negativo17-nvidia.repo
...
install -Dm0644 %{SOURCE2} %{buildroot}%{_datadir}/eternal-linux/%{_sysconfdir}/yum.repos.d/negativo17-nvidia.repo
...
sed -i 's@enabled=1@enabled=0@g' %{buildroot}%{_datadir}/eternal-linux/%{_sysconfdir}/yum.repos.d/negativo17-nvidia.repo
...
install -Dm0644 %{buildroot}%{_datadir}/eternal-linux/%{_sysconfdir}/yum.repos.d/negativo17-nvidia.repo            %{buildroot}%{_sysconfdir}/yum.repos.d/negativo17-nvidia.repo
...
%attr(0644,root,root) %{_datadir}/eternal-linux/%{_sysconfdir}/yum.repos.d/negativo17-nvidia.repo
...
%attr(0644,root,root) %{_sysconfdir}/yum.repos.d/negativo17-nvidia.repo
...
%changelog
* Thu May 29 2024 Robert Sturla <robertsturla@outlook.com>
- switch to negativo17 nvidia driver
